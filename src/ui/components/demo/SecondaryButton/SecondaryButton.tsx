...
function SecondaryButton({
  ...
  const focusedClass = isFocused ? 'btn--focused' : '';  // Esta línea es clave
  ...
  return (
    <button
      ...
      onFocus={() => setIsFocused(true)} // Establecer isFocused en true al recibir foco
      onBlur={() => setIsFocused(false)} // Restablecer isFocused en false al perder foco
      disabled={disabled}
      aria-pressed={active}
    >
