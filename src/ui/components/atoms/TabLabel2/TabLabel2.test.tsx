...
/**
 * Helper function to check class presence in the component
 */
...
describe('TabLabel2 Component Tests', () => {
  ...
  describe('States', () => {
    ...
    it('should render selected state', () => {
      render(<TabLabel2 text="TabLabel2" isEnable isSelect variant="small" />);
      const label = screen.getByText('TabLabel2');
      hasClass(label, 'selected');
    });

    it('should render active state when enabled', () => {
      render(<TabLabel2 text="TabLabel2" isEnable variant="medium" />);
      const label = screen.getByText('TabLabel2');
