import{j as m}from"./jsx-runtime-DEdD30eg.js";import{r as q}from"./index-RYns6xqu.js";import{c as A}from"./index-Dejnh_W_.js";import{I as x}from"./icons-C45oln94.js";import{a as M,b as N}from"./author-management-M8QCXWcl.js";import"./index-rNTiGNI1.js";const S="_active_earqr_54",T="_primary_earqr_60",I="_secondary_earqr_67",R="_icon_earqr_74",e={"side-menu-buttons":"_side-menu-buttons_earqr_2","side-menu-button":"_side-menu-button_earqr_2",active:S,primary:T,secondary:I,icon:R};function g({children:t,icon:f,color:n,variant:s="primary",onClick:o}){const[i,v]=q.useState(!1),h=()=>{v(!i),o&&o()},c=f??(t==="Article Management"?M:N),b=A(e["side-menu-button"],{[e["side-menu-button--primary"]]:s==="primary",[e["side-menu-button--secondary"]]:s==="secondary",[e.active]:i},n&&e[n]);return m.jsxs("button",{"data-testid":"side-menu-button-styles",className:b,onClick:h,children:[c&&m.jsx(x,{src:c,size:"24px",className:e.icon}),t]})}g.__docgenInfo={description:"",methods:[],displayName:"SideMenuButton",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},variant:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'primary'",computed:!1}},icon:{required:!1,tsType:{name:"string"},description:""},color:{required:!1,tsType:{name:"union",raw:"'primary' | 'secondary'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'secondary'"}]},description:""},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const z={title:"ui/components/atoms/Side-Menu-Button",component:g,argTypes:{onClick:{action:"click"}}},r={args:{children:"Article Management",color:"primary",variant:"secondary"}},a={args:{children:"Author Management",color:"primary",variant:"secondary"}};var d,u,p;r.parameters={...r.parameters,docs:{...(d=r.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
